...
async def test_batch_processor_processes_multiple_discoveries():
    ...
    records = [
        make_record("Drugstoc", "https://www.finelib.com/listing/drugstoc/1/"),
        make_record(
            "Helium Health",
            "https://www.finelib.com/listing/helium-health/2/",
        ),
        make_record(
            "Reliance Health",
            "https://www.finelib.com/listing/reliance-health/3/",
        ),
    ]
